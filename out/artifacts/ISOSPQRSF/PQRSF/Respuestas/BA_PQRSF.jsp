                ...
                <tr>
                    ...
                    <td>
                        <section>     
                            ...
                            <form action="O_PQRSF.jsp" method="post">
                                <input type="hidden" name="bandeja" id="bandeja" value="BA_PQRSF.jsp"/> 
                                <hr> 
                                ...
                                String [][] Lsolicitud=listas.solicitud(request.getParameter("filtro"),proceso,3);  
