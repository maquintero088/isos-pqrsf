...
<%@page import="com.qcmarcel.IsosPQRSF.Revisiones.encuesta"%>
        ...
        <table class="fondo" >
            ...
            <table class="solicitudes">
                <tr>
                    ...
                    String consulta_reciente = consultas.valores(
                                    "satisfaccion_respuesta",
                                    "fk_enc_Id", 
                                    "fk_res_Id", 
                                    consultas.valores("respuesta", "res_Id", "fk_sol_Radicado", Radicado)
                            ); 
                    if(consulta_reciente == null){
                                nota="No existen encuestas por resolver!";
                                color="66827B";
                    } else if (consulta_reciente.equals(Encuesta)){
