        ...
        <% 
            ...
            Gestion gestion= new Gestion();             
                if(request.getParameter("update")==null){  
                    ...
                    String validacion = gestion.seguimiento(gestion.seguimiento(),2,"Nuevo Usuario",request.getParameter("id"));     
                    if(validacion == null){
                        %>    
            ...
            <%}    
                    ...
                    String validacion = gestion.seguimiento(gestion.seguimiento(),2,"Editar Usuario",request.getParameter("update"));     
                    if(validacion == null){
                        %>    
                        <form action="F_Usuario.jsp" method="post">                    
                            <input type="submit" class="op1"  value="Error" />     
